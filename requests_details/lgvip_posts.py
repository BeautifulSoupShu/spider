...
REQUEST_PARAMS = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36'}
...
def get_images(url, page):
    ...
    if response.status_code == 200:
        ...
        for index, div_img in enumerate(div_content[1].find_all(name="div", class_="img")):
            ...
            response_detail = requests.get(url=url_detail, params=REQUEST_PARAMS)
